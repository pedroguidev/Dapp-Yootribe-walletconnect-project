                  ...
                  {({ isSubmitting, values, setFieldValue, setFieldError, errors, touched }) => (
                    <Form className={'formik-form'}>
                      <div className={'inputs-two-cells'}>
                          <Input required errors={errors} label={'Company legal name'} value={values?.comp_legal_name} touched={touched} fieldName={'comp_legal_name'} />
                        <Input
                          required
                          errors={errors}
                      ...
                      <div className={'inputs-two-cells'}>
                        <Input
                          ...
                          touched={touched}
                        />
                          <Input required errors={errors} label={'City'} fieldName={'city'} value={values?.city} touched={touched} />
                      </div>
                      <div className={'inputs-two-cells'}>
                          <Input required errors={errors} label={'Address'} touched={touched} value={values?.address} fieldName={'address'} />
                          <Input required errors={errors} label={'ZIP Code'} touched={touched} fieldName={'zip'} value={values?.zip} />
                      </div>
